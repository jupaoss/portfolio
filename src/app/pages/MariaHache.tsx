...
import imgCollage from "../../../graphic-assets/maria-hache/02_maria_hache_intro.png";
import imgP1_1 from "../../../graphic-assets/maria-hache/03_maria_hache_enrolar.png";
import imgP1_2 from "../../../graphic-assets/maria-hache/04_maria_hache_prender_fuego.png";
import imgP1_3 from "../../../graphic-assets/maria-hache/05_maria_hache_compartir.png";
import imgP1_4 from "../../../graphic-assets/maria-hache/06_maria_hache_personajes.png";
import imgP1_5 from "../../../graphic-assets/maria-hache/07_maria_hache_pupilas.png";
import imgP1_6 from "../../../graphic-assets/maria-hache/08_maria_hache_volar.png";
import imgP1_7 from "../../../graphic-assets/maria-hache/09_maria_hache_valla.png";
import imgP1_8 from "../../../graphic-assets/maria-hache/10_maria_hache_posts.png";
import imgP1_9 from "../../../graphic-assets/maria-hache/11_maria_hache_libertad.png";
      ...
      <div className="absolute left-0 right-0 flex flex-col gap-[180px]" style={{ top: "calc(100vh + 120px)" }}>
        ...
        <div className="relative w-full" style={{ height: "100vh" }} data-name="next project">
          ...
          <div className="absolute top-1/2 -translate-y-1/2 pointer-events-none" style={{ left: "256px" }}>
            <p className="font-['Space_Grotesk',sans-serif] font-bold leading-[62px] text-[80px] text-white">{nextProject.title}</p>
