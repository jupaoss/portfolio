...
import imgCollage from "../../../graphic-assets/project_3_maria_hache/02_maria_hache_intro.png";
import imgP1_1 from "../../../graphic-assets/project_3_maria_hache/03_maria_hache_enrolar.png";
import imgP1_2 from "../../../graphic-assets/project_3_maria_hache/04_maria_hache_prender_fuego.png";
import imgP1_3 from "../../../graphic-assets/project_3_maria_hache/05_maria_hache_compartir.png";
import imgP1_4 from "../../../graphic-assets/project_3_maria_hache/06_maria_hache_personajes.png";
import imgP1_5 from "../../../graphic-assets/project_3_maria_hache/07_maria_hache_pupilas.png";
import imgP1_6 from "../../../graphic-assets/project_3_maria_hache/08_maria_hache_volar.png";
import imgP1_7 from "../../../graphic-assets/project_3_maria_hache/09_maria_hache_valla.png";
import imgP1_8 from "../../../graphic-assets/project_3_maria_hache/10_maria_hache_posts.png";
import imgP1_9 from "../../../graphic-assets/project_3_maria_hache/11_maria_hache_libertad.png";
...
export default function MariaHache() {
  const id = "maria-hache";
    ...
    <>
      ...
      <div className="px-4 sm:px-[120px] mt-[80px] font-['Space_Grotesk',sans-serif] text-[#eaeaea] flex flex-col sm:flex-row sm:gap-[80px]">
        <div className="w-full sm:flex-1 flex flex-col gap-4">
          ...
          <SplitLines scroller={scrollContainerRef} text="How do you design for a movement that resists definition? María Hache needed a digital presence that could hold contradictions — fierce and tender, structured and free — without losing the raw energy that made it real." className="font-['Space_Grotesk',sans-serif] font-normal leading-[normal] text-[12px] tracking-[-0.12px] w-full" />
        </div>
        <div className="w-full sm:flex-1 flex flex-col gap-4 mt-[48px] sm:pt-[120px] sm:mt-0">
          ...
          <SplitLines scroller={scrollContainerRef} text="We let the characters lead. Each illustration became a portal — distinct personalities that pulled users into the world rather than explaining it. The design system was built around emotional honesty: typography that feels spoken, color that feels lived-in, interactions that feel chosen." className="font-['Space_Grotesk',sans-serif] font-normal leading-[normal] text-[12px] tracking-[-0.12px] w-full" />
        </div>
      </div>
      ...
      <div className="px-4 sm:px-[120px] mt-[80px] flex flex-col sm:flex-row sm:gap-[80px] font-['Space_Grotesk',sans-serif] text-[#eaeaea]">
        <div className="w-full sm:flex-1 flex flex-col gap-4">
          ...
          <SplitLines scroller={scrollContainerRef} text="A platform that became a home for a generation of creators who had never seen themselves reflected in digital spaces — and finally did." className="font-['Space_Grotesk',sans-serif] font-normal leading-[normal] text-[12px] tracking-[-0.12px] w-full" />
        </div>
      </div>
    ...
    <>
      ...
      <div className="-translate-y-1/2 absolute flex flex-col gap-2 items-start left-[256px] top-1/2 w-[451px] z-20" data-name="project name">
        {project.title.split(' ').map((word, i) => (
          <p key={i} className="font-['Space_Grotesk',sans-serif] font-bold leading-[0.86] text-white text-[64px] w-full">{word}</p>
        ))}
  ...
  return (
    <div ref={scrollContainerRef} className={`bg-[#000000] relative overflow-y-auto overflow-x-hidden${isMobile ? " h-screen" : " min-h-screen min-w-[1020px]"}`} data-name={isMobile ? "Project - Mobile" : "Project - Desktop"}>
      <DotGrid fixed />
