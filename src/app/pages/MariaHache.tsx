...
import imgClosing from "../../../graphic-assets/project_3_maria_hache/12_maria_hache_closing.png";
...
export default function MariaHache() {
  ...
  const mobileLayout = (
    <>
      ...
      <div className="px-4 mt-3 flex items-start gap-20 font-['Avantt',sans-serif] text-[#eaeaea]">
        ...
        <div className="flex flex-col gap-6 w-[70%]">
          <div className="flex flex-col gap-1">
            ...
            <p data-name="detail-text-line-1" className="text-[12px] font-normal leading-[1.6] tracking-[-0.12px]">Designer. <br/> In collaboration with <a href="https://www.behance.net/Duvan" target="_blank" rel="noopener noreferrer" style={{ color: "#FF4800", textDecoration: "none" }}>Duván Lopera</a></p>
          </div>
      ...
      <div className="flex flex-col gap-4 mt-4 px-4">
        ...
        <img data-scroll-img className="w-[60%] object-cover pointer-events-none rounded-lg self-center" alt="" src={imgP1_9} />
      </div>

      <div className="flex flex-col gap-4 mt-4 px-4">
        <img data-scroll-img className="w-full object-cover pointer-events-none rounded-lg" alt="" src={imgClosing} />
      </div>
  ...
  const desktopLayout = (
    <>
      <SiteHeader variant="dynamic" isDarkLogo={false} isDarkText={false} isDarkMenu={false}
        isDarkLocation={false} logoRef={logoRef} textRef={textRef} menuRef={menuRef}
        locationRef={locationRef} onLogoClick={handleLogoClick} />
      ...
      <div className="absolute left-0 right-0 flex flex-col gap-[180px]" style={{ top: "calc(100vh + 120px)" }}>
        ...
        <div className="mx-[256px] flex flex-col gap-[40px]" ref={el => { imageSectionRefs.current[2] = el; }}>
          ...
          <img data-scroll-img alt="" className="w-[60%] h-auto pointer-events-none rounded-lg self-center" src={imgP1_9} />
        </div>

        <div className="mx-[256px] flex flex-col gap-[40px]">
          <img data-scroll-img alt="" className="w-full h-auto pointer-events-none rounded-lg" src={imgClosing} />
        </div>
