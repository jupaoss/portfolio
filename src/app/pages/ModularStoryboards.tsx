  ...
  const mobileLayout = (
    <>
      ...
      <div className="px-4 -mt-5 relative z-10">
        <p className="font-['Space_Grotesk',sans-serif] font-bold text-[48px] leading-[0.86] text-black">{project.title}</p>
      </div>

      <div className="px-4 mt-3 flex items-start gap-20 font-['Space_Grotesk',sans-serif] text-black">
      ...
      <div className="px-4 sm:px-[120px] mt-[80px] font-['Space_Grotesk',sans-serif] text-black flex flex-col sm:flex-row sm:gap-[80px]">
      ...
      <div className="px-4 sm:px-[120px] mt-[80px] flex flex-col sm:flex-row sm:gap-[80px] font-['Space_Grotesk',sans-serif] text-black">
        <div className="w-full sm:flex-1 flex flex-col gap-4">
          <p data-name="scroll-label" className="font-medium text-[14px] uppercase tracking-[0.48px]">IMPACT</p>
          <SplitLines scroller={scrollContainerRef} text="Production time for new scenes dropped significantly. The system gave animators creative freedom while keeping the visual world consistent across every story." className="font-['Space_Grotesk',sans-serif] font-normal leading-[normal] text-[12px] tracking-[-0.12px] w-full" />
        </div>
      </div>

      <div className="px-4 py-[80px] flex flex-col items-center gap-6">
        <p className="font-['Space_Grotesk',sans-serif] text-[14px] uppercase tracking-[0.48px] text-black">NEXT PROJECT</p>
        ...
        <div className="text-center">
          <p className="font-['Space_Grotesk',sans-serif] font-bold text-[32px] text-black leading-[1.1]">{nextProject.title}</p>
    ...
    <>
      ...
      <div className="-translate-y-1/2 absolute content-stretch flex flex-col items-end left-[24px] top-[calc(50%-874.5px)] w-[24px] z-20" data-name="slider">
        <div className="content-stretch flex gap-[10px] h-[16px] items-center relative shrink-0 w-full" data-name="Selected">
          ...
          <p className="font-['Space_Grotesk',sans-serif] font-normal leading-[normal] relative shrink-0 text-[12px] text-black uppercase whitespace-nowrap">ABOUT</p>
        </div>
      ...
      <div className="absolute left-0 right-0 flex flex-col gap-[180px]" style={{ top: "calc(100vh + 120px)" }}>
        ...
        <div className="flex items-start justify-center" style={{ paddingLeft: 256, paddingRight: 256, gap: 'clamp(80px, calc((100vw - 1024px) / (1280 - 1024) * (240 - 80) + 80px), 240px)' }}>
          <div className="flex flex-col gap-[16px] w-[333px] font-['Space_Grotesk',sans-serif] text-black">
            <p data-name="scroll-label" className="font-medium text-[14px] uppercase tracking-[-0.12px]">THE CHALLENGE.</p>
            <SplitLines scroller={scrollContainerRef} text="Animation production is slow because assets don't talk to each other. Every new scene means rebuilding from scratch. We needed to change the fundamental relationship between components — making them composable without making them generic." className="font-['Space_Grotesk',sans-serif] font-normal leading-[normal] text-[12px] tracking-[-0.12px] w-full" />
          </div>
          <div className="flex flex-col gap-[16px] w-[333px] font-['Space_Grotesk',sans-serif] text-black pt-[180px]">
        ...
        <div className="flex items-start justify-center" style={{ paddingLeft: 256, paddingRight: 256, gap: 'clamp(80px, calc((100vw - 1024px) / (1280 - 1024) * (240 - 80) + 80px), 240px)' }}>
          <div className="flex flex-col gap-[24px] w-[333px] font-['Space_Grotesk',sans-serif] text-black">
        ...
        <div className="relative w-full" style={{ height: "100vh" }} data-name="next project">
          <p className="absolute left-1/2 -translate-x-1/2 font-['Space_Grotesk',sans-serif] font-normal text-black text-[12px] uppercase tracking-[0.48px] whitespace-nowrap" style={{ bottom: "calc(50% + 358px)" }}>
            NEXT PROJECT
          </p>
